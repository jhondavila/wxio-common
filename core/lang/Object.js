...
import langArray from './Array';
import langDate from './Date';
...
let lObject = {
                    ...
                    for (j = 0, subLn = keys.length; j < subLn; j++) {
                        ...
                        if (j === subLn - 1) {
                            ...
                            if (temp[key] === undefined || typeof temp[key] === 'string') {
                                ...
                                temp[key] = (Core.isNumeric(nextKey) || nextKey === '') ? [] : {};
                            }
    ...
    each: function (object, fn, scope) {
        var enumerables = Core.enumerables,
            i, property;
        ...
        for (key in object) {
            if (object.hasOwnProperty(key)) {
                ...
                if (value && value.constructor === Object) {
                    ...
                    propertyClassesMap[key] = this.classify(value);
                }
            }
        }
